				...
				<div class="box-body" style="width: 50%;">
					<?php echo $form->open(); ?>
						...
						<?php switch ($awardPath) {
							case '2': ?>
								<?php echo $form->bs3_dropdown('Select Item', 'field', $item = ['A1a','A1b','A1c','A1d','A1e','A2a','A2b','A2c','A2d','A3a','A3b','A3c','A5a','A5b','A5c','B1ai','B1aii','B2a','B2bi','B2bii','B2biii','B2biv','B2bv','B2bvi','B3a','B4a','B4bi','B4bii','C1a','C1b','C1c','C1d','C2a','C3a','D1a','D2ai','D2aii','D3ai','D3aii','E1a'],'',$js); ?>
							<?php break; ?>
							
							<?php case '3': ?>
								<?php echo $form->bs3_dropdown('Select Item', 'field', $item = ['A1a','A1b','A1c','A1d','A1e','A2a','A2b','A2c','A2d','A3a','A3b','A3c','A6a','A6b','A6ci','A6cii','B1ai','B1aii','B2a','B2bi','B2bii','B2biii','B2biv','B2bv','B2bvi','B3a','B4a','B4bi','B4bii','C1a','C1b','C1c','C1d','C2a','C3a','D1a','D2ai','D2aii','D3ai','D3aii','E1a'],'',$js); ?>
							<?php break; ?>

							<?php default: ?>
								<?php echo $form->bs3_dropdown('Select Item', 'field', $item = ['A1a','A1b','A1c','A1d','A1e','A2a','A2b','A2c','A2d','A3a','A3b','A3c','A4a','A4b','A4ci','A4cii','B1ai','B1aii','B2a','B2bi','B2bii','B2biii','B2biv','B2bv','B2bvi','B3a','B4a','B4bi','B4bii','C1a','C1b','C1c','C1d','C2a','C3a','D1a','D2ai','D2aii','D3ai','D3aii','E1a'],'',$js); ?>
							<?php break;} ?>
...
function matchTheSign() {
	...
	switch (awardPath){
		case '2':
			items = ['A1a','A1b','A1c','A1d','A1e','A2a','A2b','A2c','A2d','A3a','A3b','A3c','A5a','A5b','A5c','B1ai','B1aii','B2a','B2bi','B2bii','B2biii','B2biv','B2bv','B2bvi','B3a','B4a','B4bi','B4bii','C1a','C1b','C1c','C1d','C2a','C3a','D1a','D2ai','D2aii','D3ai','D3aii','E1a'];
			break;

		case '3':
			items = ['A1a','A1b','A1c','A1d','A1e','A2a','A2b','A2c','A2d','A3a','A3b','A3c','A6a','A6b','A6ci','A6cii','B1ai','B1aii','B2a','B2bi','B2bii','B2biii','B2biv','B2bv','B2bvi','B3a','B4a','B4bi','B4bii','C1a','C1b','C1c','C1d','C2a','C3a','D1a','D2ai','D2aii','D3ai','D3aii','E1a'];
			break;
