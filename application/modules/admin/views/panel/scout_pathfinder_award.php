		...
		<div class="box box-primary">
			...
			<div class="box-body" style="width: 50%;">
				<?php echo $form->open(); ?>
					<?php switch ($awardPath) {
						case '2': ?>
							<?php echo $form->bs3_dropdown('Select Item', 'field', $item = ['A1a','A1b','A1c','A1d','A1d','A2a','A2b','A2c','A3a','A3a','A3b','A5a','A5b','B1a','B2a','B3a','B4a','B4b','C1a','C1b','C2a','D1a','D2a']); ?>
						<?php break; ?>
						
						<?php case '3': ?>
							<?php echo $form->bs3_dropdown('Select Item', 'field', $item = ['A1a','A1b','A1c','A1d','A1d','A2a','A2b','A2c','A3a','A3a','A3b','A6a','A6bi','A6bii','A6biii','B1a','B2a','B3a','B4a','B4b','C1a','C1b','C2a','D1a','D2a']); ?>
						<?php break; ?>

						<?php default: ?>
							<?php echo $form->bs3_dropdown('Select Item', 'field', $item = ['A1a','A1b','A1c','A1d','A1d','A2a','A2b','A2c','A3a','A3a','A3b','A4a','A4bi','A4bii','A4biii','A5a','A5b','A6a','A6bi','A6bii','A6biii','B1a','B2a','B3a','B4a','B4b','C1a','C1b','C2a','D1a','D2a']); ?>
						<?php break;} ?>
